...
<link rel="stylesheet" type="text/css" href="<?php bloginfo('stylesheet_directory'); ?>/resmio-api/css/resmio-style.css">
<?php wp_head(); ?>
...
<div id="wrapper">
	...
	<div id="header">
	<img src="<?php bloginfo('stylesheet_directory'); ?>/resmio-api/img/resmio-logo.png"/>
	</div><!-- header -->
